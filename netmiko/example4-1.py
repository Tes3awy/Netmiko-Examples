...
with xlsxwriter.Workbook(filename="Example4-1-Device-Details.xlsx") as workbook:
    ...
    for device in devices:
        ...
        for fact in facts:
            ...
            # Checking if `packages` is in fact["running_image"]
            if "packages" in fact["running_image"]:
